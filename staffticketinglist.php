...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="staffticketinglist.php" method="get">
...
<nav class="navbar navbar-expand-lg navini">
  ...
  <div class="sidebar i" id="tum">
    ...
    <a href="staff.php" class="board d i"><i class="left-menu-icon fa-solid fa-tv"></i>DASHBOARD</a>
    ...
    <a href="staffticketing.php" class="drp nw i"><i class="fa-solid fa-caret-right"></i>ADD NEW</a>
    <a href="staffticketinglist.php" class=" drp lis i"><i class="fa-solid fa-caret-right"></i>LIST</a>
